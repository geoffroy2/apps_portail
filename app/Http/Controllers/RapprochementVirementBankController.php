...
class RapprochementVirementBankController extends Controller
{
    
    public function rapprochementVirementBank(){
        // if(!Auth::check()){
        ...
        //     $encoded = urlencode(openssl_encrypt(Auth::user()->adresse_mail.';'.Auth::user()->name,"AES-128-ECB",date("Y.m.d")));
            return redirect()->to("https://appstest.oba/portail_app/rapprochementVirementBank/web/check-app-mob");
