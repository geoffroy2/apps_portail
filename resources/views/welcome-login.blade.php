...
Il s'agit d'un espace de travail, personnalisé et sécurisé avec des droits d'accès par utilisateur.
            ...
            @else
            <form action="{{route('signinLogin')}}" method="post">
                @csrf
                <input type="email" class="form-control" name="email" required placeholder="Entrez votre adresse AD: Ex: ozouma@orangebank.ci">
